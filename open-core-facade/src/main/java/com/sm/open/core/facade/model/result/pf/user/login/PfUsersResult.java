package com.sm.open.core.facade.model.result.pf.user.login;
...
@Getter
@ToString
public class PfUsersResult implements Serializable {

    private static final long serialVersionUID = -6577981433937243957L;
