...
public class PfMessageConstant {

    public static final String SELECT_PAGE_MESSAGE_LIST_ERROR          = "selectPageMessageListError";
    public static final String SELECT_PAGE_MESSAGE_LIST_ERROR_MSG      = "分页查询消息模板列表失败";
